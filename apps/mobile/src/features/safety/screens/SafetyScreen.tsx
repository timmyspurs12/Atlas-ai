    ...
    <Screen contentStyle={styles.content}>
      <View style={styles.header}>
        ...
        <View style={styles.flex}>
          <AtlasText variant="h2">Safety centre</AtlasText>
      ...
      <Card style={styles.statusCard}>
        <View style={styles.shield}>
          <CheckCircle2 size={24} color={palette.white} />
        </View>
        <View style={styles.flex}>
          <AtlasText variant="h3">Safety setup complete</AtlasText>
          <AtlasText variant="caption" color={theme.colors.textMuted}>
            2 verified contacts · 3 delivery channels
          </AtlasText>
        </View>
      </Card>

      <View style={styles.sectionHeader}>
        <AtlasText variant="h3">Emergency contacts</AtlasText>
        <Pressable>
      ...
      <Card padded={false}>
        {[
          ...
          >
            ...
            <View style={styles.flex}>
              <AtlasText variant="label">{contact.name}</AtlasText>
              <AtlasText variant="caption" color={theme.colors.textMuted}>
                {contact.relation} · {contact.channel}
              </AtlasText>
            </View>
            <View style={styles.verified}>
              <CheckCircle2 size={14} color={palette.teal} />
      ...
      <Card padded={false}>
        <View style={styles.delivery}>
          <View style={styles.deliveryIcon}>
            <Smartphone size={19} color={palette.blue} />
          </View>
          <View style={styles.flex}>
            <AtlasText variant="label">Push notifications</AtlasText>
            <AtlasText variant="caption" color={theme.colors.textMuted}>
              Always enabled for linked Atlas users
            </AtlasText>
          </View>
          <Switch value trackColor={{ true: palette.blue }} />
        </View>
        <View
          style={[
            styles.delivery,
        ...
        >
          <View style={styles.deliveryIcon}>
            <MessageSquareText size={19} color={palette.teal} />
          </View>
          <View style={styles.flex}>
            <AtlasText variant="label">SMS</AtlasText>
            <AtlasText variant="caption" color={theme.colors.textMuted}>
        ...
        >
          <View style={styles.deliveryIcon}>
            <Mail size={19} color={palette.amber} />
          </View>
          <View style={styles.flex}>
            <AtlasText variant="label">Email</AtlasText>
            <AtlasText variant="caption" color={theme.colors.textMuted}>
              Includes time-limited safety link
            </AtlasText>
          </View>
          <Switch
            value={email}
            onValueChange={setEmail}
            trackColor={{ false: theme.colors.border, true: palette.amber }}
          />
        </View>
      </Card>
      ...
      <Card style={styles.testCard}>
        ...
        <View style={styles.flex}>
          <AtlasText variant="label">Review the SOS gesture</AtlasText>
          <AtlasText variant="caption" color={theme.colors.textMuted}>
            Holding for three seconds sends a real alert. Use the interactive demo only when
            testing.
          </AtlasText>
        </View>
      </Card>
      <Button
        label="Open SOS control"
        icon={ShieldAlert}
        variant="danger"
        onPress={() => setSos(true)}
      />
