...
function SettingRow({
  ...
  return (
    ...
    >
      <View style={[styles.rowIcon, { backgroundColor: `${iconColor}16` }]}>
        <Icon size={19} color={iconColor} />
      </View>
      <View style={styles.rowCopy}>
        <AtlasText variant="label" color={danger ? palette.red : theme.colors.text}>
          {label}
        </AtlasText>
        {description ? (
...
export function SettingsScreen() {
  ...
  const exportData = async (): Promise<void> => {
    if (mode === 'demo') {
      Alert.alert(
        'Demo export ready',
        'A production export includes your profile, permissions, trip history, and audit records.',
      );
      return;
    }
  ...
  return (
    <Screen contentStyle={styles.content}>
      ...
      <Card elevated style={styles.profileCard}>
        <Avatar
          name={session?.user.displayName ?? 'Atlas member'}
          color={palette.blue}
          size={58}
          online
        />
      ...
      <Card style={styles.planCard}>
        <View style={styles.crown}>
          <Crown size={21} color={palette.amber} />
        </View>
        <View style={styles.rowCopy}>
          <View style={styles.planTitle}>
            <AtlasText variant="h3">Atlas Family</AtlasText>
            <Pill label="14 DAYS LEFT" color={palette.blue} backgroundColor="rgba(37,99,235,0.1)" />
          </View>
          <AtlasText variant="caption" color={theme.colors.textMuted}>
            Unlimited history, AI reports, and 20 trusted people.
          </AtlasText>
        </View>
      ...
      <View style={styles.group}>
        ...
        <Card padded={false}>
          <SettingRow
            ...
            description="Sharing defaults and discoverability"
          />
          <View style={[styles.separator, { backgroundColor: theme.colors.border }]} />
          <SettingRow
            icon={MapPinned}
            iconColor={palette.blue}
            label="Places & geofences"
            description="Home, office, school, and custom zones"
          ...
          <SettingRow
            ...
            description="Verified contacts for SOS alerts"
      ...
      <View style={styles.group}>
        ...
        <Card padded={false}>
          <SettingRow
            ...
            label="Notifications"
            description="Alerts, messages, and reports"
          />
          <View style={[styles.separator, { backgroundColor: theme.colors.border }]} />
          <SettingRow
            icon={Moon}
          ...
          <SettingRow
            ...
            description="Insight controls and data permissions"
          />
        </Card>
      </View>
      ...
      <View style={styles.group}>
        ...
        <Card padded={false}>
          <SettingRow
            ...
            description="Review and revoke sessions"
          />
          <View style={[styles.separator, { backgroundColor: theme.colors.border }]} />
          <SettingRow
            icon={CloudDownload}
            ...
            description="Download a portable copy"
      ...
      <View style={styles.group}>
        <Card padded={false}>
          ...
          <SettingRow
            ...
            description="Stop sharing and schedule deletion"
      ...
      <View style={styles.helpRow}>
        ...
        <AtlasText variant="caption" color={theme.colors.textMuted}>
          Help · Privacy · Terms · Atlas AI v0.1.0
        </AtlasText>
      </View>
    </Screen>
  );
